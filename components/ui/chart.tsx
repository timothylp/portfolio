...
// biome-ignore lint/performance/noNamespaceImport: recharts fonctionne comme ça
...
export type CustomTooltipProps = {
	active?: TooltipContentBaseProps["active"];
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: C'est un style
