			...
			<div className="flex-1 overflow-auto">
				<div className="container mx-auto max-w-6xl px-6 py-8">
					...
					<div className="space-y-12">
						...
						{/* 4. Contributions détaillées */}
						<section className="rounded-lg border bg-card p-6" id="contributions">
							<h2 className="mb-6 font-semibold text-2xl text-foreground">4. Analyse des contributions GitLab</h2>
						...
						<section className="rounded-lg border bg-card p-6" id="temps">
							<h2 className="mb-6 font-semibold text-2xl text-foreground">5. Analyse du temps de travail (Asana)</h2>
